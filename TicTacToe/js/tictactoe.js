//This variable keeps track of whgose turn it is.
let activePlayer = 'X';
...
function checkWinConditions() {
    ...
    //and 9 squares are selected, the tie condition is triggered.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a line's y axis is.
        ...
        y2 = coordY2,
        //This variable stores temmporary x axis data we update in our animation loop.
        x = x1,
        ...
        animateLineDrawing();
        //This line waits 12 second. Then, clears canvas, resets game, and allows clicking again.
    ...
    function resetGame() {
        ...
        for (let i = 0; i < 9; i++) {
            //This variable getrs the HTML element i.
